...
class StudentTableTabVC: UIViewController{
    let students: [Student] = []
    
    let studentRepository: StudentsRepository = StudentsRepository()
    
    var viewModel: StudentTableTabVM!
    ...
    override func viewDidLoad() {
        ...
        viewModel = StudentTableTabVM(studentRepository: studentRepository)
...
extension StudentTableTabVC: UITableViewDataSource, UITableViewDelegate {
